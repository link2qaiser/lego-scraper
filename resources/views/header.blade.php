            ...
            <div class="page-header-inner ">
                ...
                <div class="hor-menu hidden-sm hidden-xs">
                    <ul class="nav navbar-nav">
                        ...
                        <li aria-haspopup="true" class="menu-dropdown mega-menu-dropdown  "> <a href="javascript:;"> Social Media <span class="arrow"></span> </a>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <ul class="mega-menu-submenu">
                                                    <li>
                                                        <a href="{{ url('twitterassistant') }}"> <i class="fa fa-twitter"></i> Twitter Assistent </a>
                                                    </li>

                                                </ul>
                                                <ul class="mega-menu-submenu">
                                                    <li>
                                                        <a href="{{ url('mediamanagement') }}"> <i class="fa fa-image"></i> Media Management </a>
                                                    </li>
                                            ...
                                            <div class="col-md-6">
                                                <ul class="mega-menu-submenu">
                                                    <li>
                                                        <a href="{{ url('ttsyt') }}"> <i class="fa fa-youtube"></i> Text2Speech Youtube </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('articletovideo') }}"> <i class="fa fa-youtube"></i> Artile To Video </a>
                                                    </li>
                        ...
                        <li aria-haspopup="true" class="menu-dropdown mega-menu-dropdown  "> <a href="javascript:;"> Mobile <span class="arrow"></span> </a>
                            <ul class="dropdown-menu" style="min-width: 500px">
                                <li>
                                    <div class="mega-menu-content">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <ul class="mega-menu-submenu">
                                                    <li>
                                                        <a href="{{ url('appmanangement') }}"> <i class="fa fa-twitter"></i> App Management </a>
                                                    </li>
                        ...
                        <li aria-haspopup="true" class="menu-dropdown mega-menu-dropdown  "> <a href="javascript:;"> User <span class="arrow"></span> </a>
                            <ul class="dropdown-menu" style="min-width: 500px">
                                <li>
                                    <div class="mega-menu-content">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <ul class="mega-menu-submenu">
                                                    <li>
                                                        <a href="{{ url('users') }}"> <i class="fa fa-users"></i> User Management </a>
                                                    </li>
                        ...
                        <li aria-haspopup="true" class="menu-dropdown mega-menu-dropdown  "> <a href="javascript:;"> SEO & Outreach <span class="arrow"></span> </a>
                            <ul class="dropdown-menu" style="min-width: 500px">
                                <li>
                                    <div class="mega-menu-content">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <ul class="mega-menu-submenu">
                                                    <li>
                                                        <a href="{{ url('seooutreach') }}"> <i class="fa fa-rocket"></i> Outreach </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('seotracking') }}"> <i class="fa fa-rocket"></i> SEO Tracking </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('seokeywordresearch') }}"> <i class="fa fa-search"></i>keyword research </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('seokeywordresearch') }}"> <i class="fa fa-search"></i>Site Audit </a>
                                                    </li>
                                            ...
                                            <div class="col-md-6">
                                                <ul class="mega-menu-submenu">
                                                    <li>
                                                        <a href="{{ url('yelpoutreach') }}"> <i class="fa fa-rocket"></i> Yelp Outreach </a>
                                                    </li>
                        ...
                        <li aria-haspopup="true" class="menu-dropdown mega-menu-dropdown  "> <a href="javascript:;"> Amazon <span class="arrow"></span> </a>
                            <ul class="dropdown-menu" style="min-width: 500px">
                                <li>
                                    <div class="mega-menu-content">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <ul class="mega-menu-submenu">
                                                    <li>
                                                        <a href="{{ url('amzranktracker') }}"> <i class="fa fa-rocket"></i> Rank Tracker </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <li aria-haspopup="true" class="menu-dropdown mega-menu-dropdown  "> <a href="javascript:;"> SMS <span class="arrow"></span> </a>
                            <ul class="dropdown-menu" style="min-width: 500px">
                                <li>
                                    <div class="mega-menu-content">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <ul class="mega-menu-submenu">
                                                    <li>
                                                        <a href="{{ url('smsoutreach') }}"> <i class="fa fa-rocket"></i> Outreach </a>
                                                    </li>
                        ...
                        <li aria-haspopup="true" class="menu-dropdown mega-menu-dropdown  "> <a href="javascript:;"> Utility <span class="arrow"></span> </a>
                            <ul class="dropdown-menu" style="min-width: 500px">
                                <li>
                                    <div class="mega-menu-content">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <ul class="mega-menu-submenu">
                                                    <li>
                                                        <a href="{{ url('quizapp') }}"> <i class="fa fa-twitter"></i> Quiz App </a>
                                                    </li>
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" aria-expanded="false">
                                ...
                                <span class="username username-hide-on-mobile"> {{Auth::user()->name}} ({{Auth::user()->email}}) </span>
