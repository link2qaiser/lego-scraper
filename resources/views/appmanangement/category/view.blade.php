...
<div class="row">
  <div class="col-md-2 pull-right">
    <a href="<?php echo url($module.'/category/add/'.$parent_id); ?>"  class="btn btn-block btn-info"><i class="fa fa-fw fa-plus"></i> Add Category</a>
    <br/>
  </div>
</div>
<div class="row">
                            ...
                            <?php 
                                ...
                                if(count($list['data']) > 0){
                                  ...
                                  foreach($list['data'] as $key=>$row)  {
                                    ...
                                    $html .= '<td><a href="'.url('/').'/'.$module.'/category/update/'.$row['app_id'].'" class="btn btn-xs blue">Edit</a><a class="btn btn-xs red delete" data-remove="row-'.$row['app_id'].'" href="javascript:void(0);" data-url="'.url('/').'/'.$module.'/category/delete/'.$row['app_id'].'">Delete</a></td>';
                                    $html .= '</tr>';
                                  }
                                  echo $html;
                                }
