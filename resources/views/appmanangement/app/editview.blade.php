    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <form role="form" action="{!!url('/')!!}/{{$module}}/app/update/<?php echo @$data_row['app_id'] ?>" method="post" class="make_ajax" enctype="multipart/form-data">
                       ...
                       <?php
                          if($stores){
                              foreach($stores as $key=>$row) {
                                $sel = ($row['sto_id'] == $data_row['sto_id'])?'selected':'';
                                echo '<option '.$sel.' value="'.$row['sto_id'].'">'.$row['name'].'</option>';
                            }
                          }
                          ?>
                    </select>
                 ...
                 <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="url" value="<?php echo @$data_row['url'] ?>">
                 </div>
                 <div class="col-md-3">
                    <label class="control-label">Package Name:</label>
                    <input type="text" class="form-control" name="package_name" value="<?php echo @$data_row['package_name'] ?>">
                 </div>
                 <div class="col-md-3">
                    <label class="control-label">API Url:</label>
                    <input type="text" class="form-control" name="api_url" value="<?php echo @$data_row['api_url'] ?>">
                 </div>
                 <div class="col-md-3">
                    <label class="control-label">Add Url:</label>
                    <input type="text" class="form-control" name="add_url" value="<?php echo @$data_row['add_url'] ?>">
                 </div>
                 <div class="col-md-3">
                    <label class="control-label">AddMob ID:</label>
                    <input type="text" class="form-control" name="addmob_id" value="<?php echo @$data_row['addmob_id'] ?>">
                 </div>
                 <div class="col-md-3">
                    <label class="control-label">Startapp Dev ID:</label>
                    <input type="text" class="form-control" name="startapp_dev_id" value="<?php echo @$data_row['startapp_dev_id'] ?>">
                 </div>
                 <div class="col-md-3">
                    <label class="control-label">Startapp App ID:</label>
                    <input type="text" class="form-control" name="startapp_app_id" value="<?php echo @$data_row['startapp_app_id'] ?>">
                 </div>
                 <div class="col-md-3">
                    <label class="control-label">Google Analytic ID:</label>
                    <input type="text" class="form-control" name="goolg_analytic_id" value="<?php echo @$data_row['goolg_analytic_id'] ?>">
                 </div>
                 </div>
