        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              <div class="caption"> <i class="fa fa-gift"></i>Edit Post</div>
            ...
            <div class="portlet-body form"> 
              <!-- BEGIN FORM-->
              <form action="{!!url('post/update')!!}/<?php echo $post['p_id']?>" method="post" class="horizontal-form" enctype="multipart/form-data">
              <div class="form-body">
              <div class="row">
                  <div class="col-md-6">
                  ...
                  <label class="control-label">Category</label>
					...
					$selected	=	($row['c_id'] == $post['c_id'])?'selected="selected"':"";
					?>
                    <option <?php echo $selected; ?>  value="<?php echo $row['c_id'];?>"><?php echo $row['name'];?></option>
                    <?php } ?>
                    </select>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="firstName" class="form-control" name="title" value="<?php echo $post['title']; ?>">
                    </div>
                  </div>
                  <!--/span-->
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="heading" id="lastName" class="form-control" value="<?php echo $post['heading']; ?>">
                    </div>
                  </div>
                  <!--/span--> 
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <textarea name="meta_desc"  class="form-control" ><?php echo $post['meta_desc']; ?></textarea>
                      <span class="help-block">It will be long text </span> </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="control-label">Meta Keywords</label>
                      <textarea  name="meta_key" class="form-control" ><?php echo $post['meta_key']; ?></textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="image_alt" id="lastName" class="form-control" value="<?php echo $post['image_alt']; ?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="is_iframe">
                          ...
                          <option value="1" <?php if($post['is_iframe'] == 1) echo 'selected="selected"'; ?> >Iframe</option>
                          <option value="2" <?php if($post['is_iframe'] == 2) echo 'selected="selected"'; ?>>Javascript</option>
                          <option value="3" <?php if($post['is_iframe'] == 3) echo 'selected="selected"'; ?>>Player</option>
                          <option value="4" <?php if($post['is_iframe'] == 4) echo 'selected="selected"'; ?>>Custom</option>
                        </select>
                      </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea type="text" name="streamin_link"  class="form-control" ><?php echo $post['streamin_link']; ?></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <textarea name="content" id="summernote_1"><?php echo $post['content']; ?></textarea>
                  </div>
                </div>
