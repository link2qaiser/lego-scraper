      ...
      <div class="row">
        <div class="col-md-12"> 
          ...
          <div class="portlet box green">
            ...
            <div class="portlet-body flip-scroll"> <a class="btn btn-primary" href="{!!url('/post/addform')!!}"> +Add New </a> <br/>
              <br/>
              <table class="table table-bordered table-striped table-condensed flip-content">
				...
				?>
                  <tr>
                    ...
                    <td><img src="http://www.snowflake.tv/uploads/thumb-<?php echo $row['image']; ?>" /></td>
                    <td><?php echo ($row['streamin_link'] != "")?'<span class="badge badge-roundless badge-success">Added</span>':''; ?></td>
                    <td><a href="{!!url('/')!!}/post/updateform/<?php echo $row['p_id']; ?>">Edit</a> | <a href="{!!url('/')!!}/post/delete/<?php echo $row['p_id']; ?>">Delete</a> | <a target="_blank" href="http://snowflake.tv/<?php echo $row['slug']; ?>">View</a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
